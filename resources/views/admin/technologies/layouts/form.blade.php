...
<main>
    <div class="container">
        <form action="{{ (Route::currentRouteName() == 'admin.technologies.edit') ? route('admin.technologies.update', $technology->id ) : route('admin.technologies.store') }}" method="POST" class="text-center card">
            ...
            <div class="row row-cols-2 g-2 text-white">
                <div class="col flex-column-center my-2">
                    <div class="form-group mb-2">
                        ...
                        @elseif (Route::currentRouteName() == 'admin.technologies.create')
                            <input type="text" class="form-control p-2" id="name" name="name" placeholder="Enter technology name..." value="{{ old('name') }}">
                        @endif
                    </div>
                    @error("name")
                ...
                <div class="col flex-column-center my-2">
                    <div class="form-group mb-2">
                        ...
                        @elseif (Route::currentRouteName() == 'admin.technologies.create')
                            <input type="text" class="form-control p-2" id="color" name="color" placeholder="Enter technology color label..." value="{{ old('color') }}">
                        @endif
                    </div>
                    @error("color")
                    <div class="alert alert-warning">
